...
<body>
    ...
    <div class="container card mt-4 p-3 wb-5 border border-dark shadow-lg p-3 mb-5 bg-body rounded" style="width: 25rem;">
        <div class="form container">
            <form action="signUpReader" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" cols="33" name="education"  required></textarea>
                </div>
                <div class="mb-3">
                ...
                <div class="d-flex flex-row justify-content-around">
                    <div><input type="submit" class="btn btn-success" name="addReader" value="Sign up"></div>
